...
system.l3bus = L2XBar(width=128*8)#TODO: Make sure the width is correct
...
#Newly added section, need to verify functionality.
#create bus to connect L2 cache and HBM

#system wide bus
system.membus = SystemXBar()

system.l3cache = L3HBMCache() #TODO: Configure the L3HBM Cache
system.l3cache.connectCPUSideBus(system.l3bus)
system.l3cache.connectMemSideBus(system.membus)

system.channels = 8 #TODO: Configure the channels
